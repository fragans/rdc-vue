<template>
  <div class="flex">
    ...
    <div class="w-20 lg:pt-0 pt-4 md:flex flex-col items-center hidden">
      <span class="block border border-gray-300 rounded-full w-4 h-4" />
      <span class="block bg-gray-200 w-1 h-full" />
    </div>
    <router-link :to="`/event/${item.id}`" class="w-full">
      <div class="xl:max-w-3xl lg:max-w-2xl rounded overflow-hidden">
        <div class="md:px-6 py-4 lg:border-none border-t-[2px] border-gray-300">
